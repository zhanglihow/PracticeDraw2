...
public class Practice12PathEffectView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 第三处：DashPathEffect
        PathEffect pathEffect3=new DashPathEffect(new float[]{20,5,10,5},5);
        ...
        path1.lineTo(21,21);
        path1.close();
        PathEffect pathEffect4=new PathDashPathEffect(path1,50,0,PathDashPathEffect.Style.MORPH);
